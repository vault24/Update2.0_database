...
import {
  Settings, Bell, Lock, Palette, Monitor, Moon, Sun,
  Smartphone, Mail, Shield,
  Key, Eye, EyeOff, Loader2, Check, UserCog, LogOut, Trash2,
  AlertTriangle, Download, BellRing
} from 'lucide-react';
...
export default function SettingsPage() {
  ...
  // Notification settings (email is server-authoritative; push drives a real
  // Web Push subscription — the decorative local-only toggles were removed)
  ...
  return (
    <div className="space-y-6 max-w-full overflow-x-clip pb-6">
      ...
      <div className="space-y-6">
        ...
        {/* Privacy Section — only the real, server-enforced public-profile
            visibility (accounts without a student profile have nothing to set) */}
        {publicProfile && (
        <motion.div
          initial={false}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="space-y-4">
            ...
            {/* Logout (this device) — the only logout entry point in the portal */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="flex items-center gap-3">
