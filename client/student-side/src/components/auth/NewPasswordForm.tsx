...
export function NewPasswordForm({ 
  ...
  const getPasswordStrength = (password: string): PasswordStrength => {
    ...
    else if (score >= 3) color = 'text-warning';
                ...
                <div className="flex-1 h-2 bg-muted rounded-full overflow-hidden">
                  <div 
                    className={cn(
                      ...
                      passwordStrength.score >= 3 ? "bg-warning" : "bg-destructive"
                    )}
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={cn(
                "pl-10 pr-10 h-11",
                confirmPassword && (doPasswordsMatch ? "border-success" : "border-destructive")
              )}
            ...
            {confirmPassword && doPasswordsMatch && (
              <CheckCircle className="absolute right-10 top-1/2 -translate-y-1/2 w-4 h-4 text-success" />
            )}
          </div>
