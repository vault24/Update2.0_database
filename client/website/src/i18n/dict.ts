...
export const dict = {
  en: {
    ...
    "nav.campus": "Campus",
    "nav.academicInfo": "Academic Information",
    ...
    "nav.deptStats": "Department Statistics",
  ...
  bn: {
    ...
    "nav.history": "ইতিহাস",
    "nav.principal": "অধ্যক্ষের বাণী",
    "nav.campus": "ক্যাম্পাস",
    "nav.academicInfo": "একাডেমিক তথ্য",
    "nav.projects": "গবেষণা ও প্রকল্প",
    "nav.clubs": "ক্লাব",
    "nav.sports": "খেলাধুলা",
    "nav.library": "লাইব্রেরি",
    "nav.news": "সংবাদ",
    "nav.downloads": "ডাউনলোড",
    "nav.studentStats": "শিক্ষার্থী পরিসংখ্যান",
    "nav.deptStats": "বিভাগ পরিসংখ্যান",
