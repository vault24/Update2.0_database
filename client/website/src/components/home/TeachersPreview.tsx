              ...
              <Reveal key={tc.id} delay={i * 0.05}>
                ...
                >
                  <div className="relative">
                    <div className="absolute -inset-1 rounded-full bg-gradient-to-br from-primary to-accent opacity-0 blur transition-opacity group-hover:opacity-60" />
                    {tc.profilePhoto ? (
                  ...
                  <p className="text-sm text-accent">{tc.designation}</p>
