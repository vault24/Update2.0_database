...
export const API_ENDPOINTS = {
  ...
  students: {
    ...
    // DRF registers detail @action routes with the method name (underscores);
    // these must match exactly or the request 404s.
    ...
    calculateSemesterResult: (id: string) => `/students/${id}/calculate_semester_result_from_marks/`,
  ...
  teachers: {
    ...
    uploadPhoto: (id: string) => `/teachers/${id}/upload_photo/`,
